...
BASE_DIR="/home/richards/satoshi.yoshiji/scratch/40.CLSA_TG_to_HDL/02.regenie/03.step2"
...
original_script="$BASE_DIR/01.regenie_step2.sh"
...
for dir in "${directories[@]}"; do
    ...
    copied_script="$TARGET_DIR/01.regenie_step2.sh"
